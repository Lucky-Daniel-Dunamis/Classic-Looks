  ...
  <section class="py-12 scroll-mt-20 bg-gray-50" id="products">
    <main class="container mx-auto px-4">
      <header class="flex justify-between items-center mb-8">
        ...
        <nav class="flex space-x-4" aria-label="Products crousel controls">
          <button
            @click="prevSlide"
            ...
            <article>
              <figure class="relative">
                ...
                <figcaption
                  ...
                  class="absolute top-3 right-3 bg-red-500 text-white-xs font-bold px-2 py-1 rounded-full"
                >
                  -{{ product.discount }}%
                </figcaption>
